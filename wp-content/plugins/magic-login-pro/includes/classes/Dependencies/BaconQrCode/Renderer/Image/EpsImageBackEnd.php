...
namespace MagicLogin\Dependencies\BaconQrCode\Renderer\Image;

use MagicLogin\Dependencies\BaconQrCode\Exception\RuntimeException;
use MagicLogin\Dependencies\BaconQrCode\Renderer\Color\Alpha;
use MagicLogin\Dependencies\BaconQrCode\Renderer\Color\Cmyk;
use MagicLogin\Dependencies\BaconQrCode\Renderer\Color\ColorInterface;
use MagicLogin\Dependencies\BaconQrCode\Renderer\Color\Gray;
use MagicLogin\Dependencies\BaconQrCode\Renderer\Color\Rgb;
use MagicLogin\Dependencies\BaconQrCode\Renderer\Path\Close;
use MagicLogin\Dependencies\BaconQrCode\Renderer\Path\Curve;
use MagicLogin\Dependencies\BaconQrCode\Renderer\Path\EllipticArc;
use MagicLogin\Dependencies\BaconQrCode\Renderer\Path\Line;
use MagicLogin\Dependencies\BaconQrCode\Renderer\Path\Move;
use MagicLogin\Dependencies\BaconQrCode\Renderer\Path\Path;
use MagicLogin\Dependencies\BaconQrCode\Renderer\RendererStyle\Gradient;
use MagicLogin\Dependencies\BaconQrCode\Renderer\RendererStyle\GradientType;
...
final class EpsImageBackEnd implements ImageBackEndInterface
{
    ...
    public function new(int $size, ColorInterface $backgroundColor) : void
    {
        $this->eps = "%!PS-Adobe-3.0 EPSF-3.0\n"
            . "%%Creator: MagicLogin\Dependencies\BaconQrCode\n"
