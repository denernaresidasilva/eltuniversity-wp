...
namespace MagicLogin\Dependencies\Twilio\Jwt\Grants;
...
class PlaybackGrant implements Grant {
     ...
     * Returns the grant
     *
     * @return array playback grant from the MagicLogin\Dependencies\Twilio API
     */
     ...
     *
     * @param array $grant playback grant from MagicLogin\Dependencies\Twilio API
