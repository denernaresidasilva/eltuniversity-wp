...
namespace MagicLogin\Dependencies\Twilio\Security;

use MagicLogin\Dependencies\Twilio\Values;

/**
 * RequestValidator is a helper to validate that a request to a web server was actually made from MagicLogin\Dependencies\Twilio
 * EXAMPLE USAGE:
...
class RequestValidator {
    ...
    /**
     * @access private
     * @var string The auth token to the MagicLogin\Dependencies\Twilio Account
     */
    private $authToken;
     ...
     * constructor
     * @access public
     * @param string $authToken the auth token of the MagicLogin\Dependencies\Twilio user's account
     ...
     * @param array $data the MagicLogin\Dependencies\Twilio parameters the request was made with
     * @return string
     */
    ...
    /**
     * The only method the client should be running...takes the MagicLogin\Dependencies\Twilio signature, their URL, and the MagicLogin\Dependencies\Twilio params and validates the signature
     *
