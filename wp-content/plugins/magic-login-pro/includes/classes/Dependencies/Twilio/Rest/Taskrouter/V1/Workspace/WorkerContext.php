...
use MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\Worker\WorkerChannelList;
use MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\Worker\ReservationList;
use MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\Worker\WorkersRealTimeStatisticsList;
use MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\Worker\WorkerStatisticsList;
use MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\Worker\WorkersCumulativeStatisticsList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\Worker\ReservationContext reservations(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\Worker\WorkersRealTimeStatisticsContext realTimeStatistics()
 * @method \MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\Worker\WorkerStatisticsContext statistics()
 * @method \MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\Worker\WorkersCumulativeStatisticsContext cumulativeStatistics()
 * @method \MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\Worker\WorkerChannelContext workerChannels(string $sid)
 */
