...
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\Service\AlphaSenderList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\Service\PhoneNumberList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\Service\DestinationAlphaSenderList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\Service\UsAppToPersonUsecaseList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\Service\ChannelSenderList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\Service\ShortCodeList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\Service\UsAppToPersonList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\Service\ShortCodeContext shortCodes(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\Service\UsAppToPersonContext usAppToPerson(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\Service\PhoneNumberContext phoneNumbers(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\Service\AlphaSenderContext alphaSenders(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\Service\DestinationAlphaSenderContext destinationAlphaSenders(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\Service\ChannelSenderContext channelSenders(string $sid)
 */
