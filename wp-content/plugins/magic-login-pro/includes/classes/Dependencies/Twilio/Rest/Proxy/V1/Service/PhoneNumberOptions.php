 ...
 *
 * MagicLogin\Dependencies\Twilio - Proxy
...
namespace MagicLogin\Dependencies\Twilio\Rest\Proxy\V1\Service;
...
{
    /**
     * @param string $sid The SID of a MagicLogin\Dependencies\Twilio [IncomingPhoneNumber](https://www.twilio.com/docs/phone-numbers/api/incomingphonenumber-resource) resource that represents the MagicLogin\Dependencies\Twilio Number you would like to assign to your Proxy Service.
...
class CreatePhoneNumberOptions extends Options
    ...
    /**
     * The SID of a MagicLogin\Dependencies\Twilio [IncomingPhoneNumber](https://www.twilio.com/docs/phone-numbers/api/incomingphonenumber-resource) resource that represents the MagicLogin\Dependencies\Twilio Number you would like to assign to your Proxy Service.
     *
     * @param string $sid The SID of a MagicLogin\Dependencies\Twilio [IncomingPhoneNumber](https://www.twilio.com/docs/phone-numbers/api/incomingphonenumber-resource) resource that represents the MagicLogin\Dependencies\Twilio Number you would like to assign to your Proxy Service.
