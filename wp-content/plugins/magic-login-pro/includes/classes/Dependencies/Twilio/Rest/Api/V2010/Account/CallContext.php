...
use MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\TranscriptionList;
use MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\RecordingList;
use MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\UserDefinedMessageSubscriptionList;
use MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\EventList;
use MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\NotificationList;
use MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\UserDefinedMessageList;
use MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\SiprecList;
use MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\StreamList;
use MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\PaymentList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\TranscriptionContext transcriptions(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\SiprecContext siprec(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\UserDefinedMessageSubscriptionContext userDefinedMessageSubscriptions(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\PaymentContext payments(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\RecordingContext recordings(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\NotificationContext notifications(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Call\StreamContext streams(string $sid)
 */
