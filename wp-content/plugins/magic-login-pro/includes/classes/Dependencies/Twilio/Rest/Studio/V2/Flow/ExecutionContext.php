...
use MagicLogin\Dependencies\Twilio\Rest\Studio\V2\Flow\Execution\ExecutionStepList;
use MagicLogin\Dependencies\Twilio\Rest\Studio\V2\Flow\Execution\ExecutionContextList;


/**
 * @property ExecutionStepList $steps
 * @property ExecutionContextList $executionContext
 * @method \MagicLogin\Dependencies\Twilio\Rest\Studio\V2\Flow\Execution\ExecutionContextContext executionContext()
 * @method \MagicLogin\Dependencies\Twilio\Rest\Studio\V2\Flow\Execution\ExecutionStepContext steps(string $sid)
 */
