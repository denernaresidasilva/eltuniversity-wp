...
use MagicLogin\Dependencies\Twilio\Rest\Verify\V2\Service\RateLimit\BucketList;


/**
 * @property BucketList $buckets
 * @method \MagicLogin\Dependencies\Twilio\Rest\Verify\V2\Service\RateLimit\BucketContext buckets(string $sid)
 */
