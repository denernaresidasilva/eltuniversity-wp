 ...
 *
 * MagicLogin\Dependencies\Twilio - Insights
...
namespace MagicLogin\Dependencies\Twilio\Rest\Insights\V1\Call;
...
abstract class AnnotationOptions
{
     ...
     * @param string $comment Specify any comments pertaining to the call. `comment` has a maximum character limit of 100. MagicLogin\Dependencies\Twilio does not treat this field as PII, so no PII should be included in the `comment`.
     * @param string $incident Associate this call with an incident or support ticket. The `incident` parameter is of type string with a maximum character limit of 100. MagicLogin\Dependencies\Twilio does not treat this field as PII, so no PII should be included in `incident`.
...
class UpdateAnnotationOptions extends Options
    ...
    /**
     * Specify any comments pertaining to the call. `comment` has a maximum character limit of 100. MagicLogin\Dependencies\Twilio does not treat this field as PII, so no PII should be included in the `comment`.
     *
     * @param string $comment Specify any comments pertaining to the call. `comment` has a maximum character limit of 100. MagicLogin\Dependencies\Twilio does not treat this field as PII, so no PII should be included in the `comment`.
     * @return $this Fluent Builder
     */
    ...
    /**
     * Associate this call with an incident or support ticket. The `incident` parameter is of type string with a maximum character limit of 100. MagicLogin\Dependencies\Twilio does not treat this field as PII, so no PII should be included in `incident`.
     *
     * @param string $incident Associate this call with an incident or support ticket. The `incident` parameter is of type string with a maximum character limit of 100. MagicLogin\Dependencies\Twilio does not treat this field as PII, so no PII should be included in `incident`.
     * @return $this Fluent Builder
     */
