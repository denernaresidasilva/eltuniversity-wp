 ...
 *
 * MagicLogin\Dependencies\Twilio - Preview
...
namespace MagicLogin\Dependencies\Twilio\Rest\Preview\HostedNumbers;
...
abstract class HostedNumberOrderOptions
{
     ...
     * @param string $smsUrl The URL that MagicLogin\Dependencies\Twilio should request when somebody sends an SMS to the phone number. This will be copied onto the IncomingPhoneNumber resource.
     ...
     * @param string $smsFallbackUrl A URL that MagicLogin\Dependencies\Twilio will request if an error occurs requesting or executing the TwiML defined by SmsUrl. This will be copied onto the IncomingPhoneNumber resource.
     ...
     * @param string $smsApplicationSid Optional. The 34 character sid of the application MagicLogin\Dependencies\Twilio should use to handle SMS messages sent to this number. If a `SmsApplicationSid` is present, MagicLogin\Dependencies\Twilio will ignore all of the SMS urls above and use those set on the application.
...
class CreateHostedNumberOrderOptions extends Options
    ...
    /**
     * The URL that MagicLogin\Dependencies\Twilio should request when somebody sends an SMS to the phone number. This will be copied onto the IncomingPhoneNumber resource.
     *
     * @param string $smsUrl The URL that MagicLogin\Dependencies\Twilio should request when somebody sends an SMS to the phone number. This will be copied onto the IncomingPhoneNumber resource.
     * @return $this Fluent Builder
     */
    ...
    /**
     * A URL that MagicLogin\Dependencies\Twilio will request if an error occurs requesting or executing the TwiML defined by SmsUrl. This will be copied onto the IncomingPhoneNumber resource.
     *
     * @param string $smsFallbackUrl A URL that MagicLogin\Dependencies\Twilio will request if an error occurs requesting or executing the TwiML defined by SmsUrl. This will be copied onto the IncomingPhoneNumber resource.
     * @return $this Fluent Builder
     */
    ...
    /**
     * Optional. The 34 character sid of the application MagicLogin\Dependencies\Twilio should use to handle SMS messages sent to this number. If a `SmsApplicationSid` is present, MagicLogin\Dependencies\Twilio will ignore all of the SMS urls above and use those set on the application.
     *
     * @param string $smsApplicationSid Optional. The 34 character sid of the application MagicLogin\Dependencies\Twilio should use to handle SMS messages sent to this number. If a `SmsApplicationSid` is present, MagicLogin\Dependencies\Twilio will ignore all of the SMS urls above and use those set on the application.
     * @return $this Fluent Builder
     */
