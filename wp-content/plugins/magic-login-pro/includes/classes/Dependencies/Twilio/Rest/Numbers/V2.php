...
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\AuthorizationDocumentList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\BulkHostedNumberOrderList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\BundleCloneList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\HostedNumberOrderList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\RegulatoryComplianceList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\AuthorizationDocumentContext authorizationDocuments(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\BulkHostedNumberOrderContext bulkHostedNumberOrders(string $bulkHostingSid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\HostedNumberOrderContext hostedNumberOrders(string $sid)
 */
