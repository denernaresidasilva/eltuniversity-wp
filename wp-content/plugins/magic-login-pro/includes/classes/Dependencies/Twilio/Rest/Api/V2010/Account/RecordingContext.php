...
use MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Recording\AddOnResultList;
use MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Recording\TranscriptionList;


/**
 * @property AddOnResultList $addOnResults
 * @property TranscriptionList $transcriptions
 * @method \MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Recording\AddOnResultContext addOnResults(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Recording\TranscriptionContext transcriptions(string $sid)
 */
