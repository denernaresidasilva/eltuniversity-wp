...
abstract class FlexUserOptions
{
     ...
     * @param string $userSid The unique SID identifier of the MagicLogin\Dependencies\Twilio Unified User.
...
class UpdateFlexUserOptions extends Options
    ...
    /**
     * The unique SID identifier of the MagicLogin\Dependencies\Twilio Unified User.
     *
     * @param string $userSid The unique SID identifier of the MagicLogin\Dependencies\Twilio Unified User.
     * @return $this Fluent Builder
     */
