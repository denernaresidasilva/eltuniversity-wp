...
use MagicLogin\Dependencies\Twilio\Rest\Chat\V3\ChannelList;
use MagicLogin\Dependencies\Twilio\Version;

/**
 * @property ChannelList $channels
 * @method \MagicLogin\Dependencies\Twilio\Rest\Chat\V3\ChannelContext channels(string $serviceSid, string $sid)
 */
