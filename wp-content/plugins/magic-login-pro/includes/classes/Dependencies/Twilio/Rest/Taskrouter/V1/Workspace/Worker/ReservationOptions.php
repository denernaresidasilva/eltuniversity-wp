...
abstract class ReservationOptions
{
     ...
     * @param string $dequeueTo The contact URI of the worker when executing a Dequeue instruction. Can be the URI of the MagicLogin\Dependencies\Twilio Client, the SIP URI for Programmable SIP, or the [E.164](https://www.twilio.com/docs/glossary/what-e164) formatted phone number, depending on the destination.
     ...
     * @param string $callTo The contact URI of the worker when executing a Call instruction. Can be the URI of the MagicLogin\Dependencies\Twilio Client, the SIP URI for Programmable SIP, or the [E.164](https://www.twilio.com/docs/glossary/what-e164) formatted phone number, depending on the destination.
     ...
     * @param string $to The Contact URI of the worker when executing a Conference instruction. Can be the URI of the MagicLogin\Dependencies\Twilio Client, the SIP URI for Programmable SIP, or the [E.164](https://www.twilio.com/docs/glossary/what-e164) formatted phone number, depending on the destination.
...
class UpdateReservationOptions extends Options
    ...
    /**
     * The contact URI of the worker when executing a Dequeue instruction. Can be the URI of the MagicLogin\Dependencies\Twilio Client, the SIP URI for Programmable SIP, or the [E.164](https://www.twilio.com/docs/glossary/what-e164) formatted phone number, depending on the destination.
     *
     * @param string $dequeueTo The contact URI of the worker when executing a Dequeue instruction. Can be the URI of the MagicLogin\Dependencies\Twilio Client, the SIP URI for Programmable SIP, or the [E.164](https://www.twilio.com/docs/glossary/what-e164) formatted phone number, depending on the destination.
     * @return $this Fluent Builder
     */
    ...
    /**
     * The contact URI of the worker when executing a Call instruction. Can be the URI of the MagicLogin\Dependencies\Twilio Client, the SIP URI for Programmable SIP, or the [E.164](https://www.twilio.com/docs/glossary/what-e164) formatted phone number, depending on the destination.
     *
     * @param string $callTo The contact URI of the worker when executing a Call instruction. Can be the URI of the MagicLogin\Dependencies\Twilio Client, the SIP URI for Programmable SIP, or the [E.164](https://www.twilio.com/docs/glossary/what-e164) formatted phone number, depending on the destination.
     * @return $this Fluent Builder
     */
    ...
    /**
     * The Contact URI of the worker when executing a Conference instruction. Can be the URI of the MagicLogin\Dependencies\Twilio Client, the SIP URI for Programmable SIP, or the [E.164](https://www.twilio.com/docs/glossary/what-e164) formatted phone number, depending on the destination.
     *
     * @param string $to The Contact URI of the worker when executing a Conference instruction. Can be the URI of the MagicLogin\Dependencies\Twilio Client, the SIP URI for Programmable SIP, or the [E.164](https://www.twilio.com/docs/glossary/what-e164) formatted phone number, depending on the destination.
     * @return $this Fluent Builder
     */
