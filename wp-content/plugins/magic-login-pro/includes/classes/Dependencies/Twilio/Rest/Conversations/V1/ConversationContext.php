...
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Conversation\ParticipantList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Conversation\MessageList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Conversation\WebhookList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Conversation\MessageContext messages(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Conversation\ParticipantContext participants(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Conversation\WebhookContext webhooks(string $sid)
 */
