...
namespace MagicLogin\Dependencies\Twilio\Rest\Chat;
...
use MagicLogin\Dependencies\Twilio\Rest\Chat\V1\CredentialList;
use MagicLogin\Dependencies\Twilio\Rest\Chat\V1\ServiceList;
use MagicLogin\Dependencies\Twilio\Version;

/**
 * @property CredentialList $credentials
 * @property ServiceList $services
 * @method \MagicLogin\Dependencies\Twilio\Rest\Chat\V1\CredentialContext credentials(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Chat\V1\ServiceContext services(string $sid)
 */
