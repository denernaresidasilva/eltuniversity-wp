...
namespace MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\Interaction;
...
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\Interaction\InteractionChannel\InteractionChannelParticipantList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\Interaction\InteractionChannel\InteractionChannelInviteList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\Interaction\InteractionChannel\InteractionTransferList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\Interaction\InteractionChannel\InteractionTransferContext transfers(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\Interaction\InteractionChannel\InteractionChannelParticipantContext participants(string $sid)
 */
class InteractionChannelContext extends InstanceContext
     ...
     * @param string $interactionSid The unique string created by MagicLogin\Dependencies\Twilio to identify an Interaction resource, prefixed with KD.
     * @param string $sid The unique string created by MagicLogin\Dependencies\Twilio to identify an Interaction Channel resource, prefixed with UO.
     */
