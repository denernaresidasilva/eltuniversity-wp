...
abstract class RoomOptions
{
     ...
     * @param string $statusCallback The URL MagicLogin\Dependencies\Twilio should call using the `status_callback_method` to send status information to your application on every room event. See [Status Callbacks](https://www.twilio.com/docs/video/api/status-callbacks) for more info.
     * @param string $statusCallbackMethod The HTTP method MagicLogin\Dependencies\Twilio should use to call `status_callback`. Can be `POST` or `GET`.
...
class CreateRoomOptions extends Options
    ...
    /**
     * The URL MagicLogin\Dependencies\Twilio should call using the `status_callback_method` to send status information to your application on every room event. See [Status Callbacks](https://www.twilio.com/docs/video/api/status-callbacks) for more info.
     *
     * @param string $statusCallback The URL MagicLogin\Dependencies\Twilio should call using the `status_callback_method` to send status information to your application on every room event. See [Status Callbacks](https://www.twilio.com/docs/video/api/status-callbacks) for more info.
     * @return $this Fluent Builder
     */
    ...
    /**
     * The HTTP method MagicLogin\Dependencies\Twilio should use to call `status_callback`. Can be `POST` or `GET`.
     *
     * @param string $statusCallbackMethod The HTTP method MagicLogin\Dependencies\Twilio should use to call `status_callback`. Can be `POST` or `GET`.
     * @return $this Fluent Builder
     */
