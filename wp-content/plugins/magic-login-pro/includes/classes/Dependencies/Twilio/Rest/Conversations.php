...
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1;
...
class Conversations extends ConversationsBase {
     ...
     */
    protected function getConfiguration(): \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\ConfigurationList {
     ...
     * @deprecated Use v1->configuration() instead.
     */
    protected function contextConfiguration(): \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\ConfigurationContext {
        echo "configuration() is deprecated. Use v1->configuration() instead.";
        return $this->v1->configuration();
    }
     ...
     */
    protected function getAddressConfigurations(): \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\AddressConfigurationList {
     ...
     */
    protected function contextAddressConfigurations(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\AddressConfigurationContext {
     ...
     */
    protected function getConversations(): \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\ConversationList {
     ...
     *                    resource.
     */
    protected function contextConversations(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\ConversationContext {
     ...
     */
    protected function getCredentials(): \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\CredentialList {
     ...
     *                    resource.
     */
    protected function contextCredentials(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\CredentialContext {
     ...
     */
    protected function getParticipantConversations(): \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\ParticipantConversationList {
     ...
     */
    protected function getRoles(): \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\RoleList {
     ...
     */
    protected function contextRoles(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\RoleContext {
     ...
     */
    protected function getServices(): \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\ServiceList {
     ...
     *                    resource.
     */
    protected function contextServices(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\ServiceContext {
     ...
     */
    protected function getUsers(): \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\UserList {
     ...
     */
    protected function contextUsers(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\UserContext {
