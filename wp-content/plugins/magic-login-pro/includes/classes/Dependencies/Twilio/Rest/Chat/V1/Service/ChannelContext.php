...
namespace MagicLogin\Dependencies\Twilio\Rest\Chat\V1\Service;
...
use MagicLogin\Dependencies\Twilio\Rest\Chat\V1\Service\Channel\MemberList;
use MagicLogin\Dependencies\Twilio\Rest\Chat\V1\Service\Channel\InviteList;
use MagicLogin\Dependencies\Twilio\Rest\Chat\V1\Service\Channel\MessageList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Chat\V1\Service\Channel\MemberContext members(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Chat\V1\Service\Channel\MessageContext messages(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Chat\V1\Service\Channel\InviteContext invites(string $sid)
 */
