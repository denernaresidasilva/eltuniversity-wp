...
namespace MagicLogin\Dependencies\Twilio\Rest\Numbers\V2;
...
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\RegulatoryCompliance\RegulationList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\RegulatoryCompliance\SupportingDocumentList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\RegulatoryCompliance\BundleList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\RegulatoryCompliance\EndUserTypeList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\RegulatoryCompliance\EndUserList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\RegulatoryCompliance\SupportingDocumentTypeList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\RegulatoryCompliance\SupportingDocumentContext supportingDocuments(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\RegulatoryCompliance\EndUserContext endUsers(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\RegulatoryCompliance\BundleContext bundles(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\RegulatoryCompliance\SupportingDocumentTypeContext supportingDocumentTypes(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\RegulatoryCompliance\RegulationContext regulations(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Numbers\V2\RegulatoryCompliance\EndUserTypeContext endUserTypes(string $sid)
 */
