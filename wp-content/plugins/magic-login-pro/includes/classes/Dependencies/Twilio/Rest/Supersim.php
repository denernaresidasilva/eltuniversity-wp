...
use MagicLogin\Dependencies\Twilio\Rest\Supersim\V1;

class Supersim extends SupersimBase {
    /**
     * @deprecated Use v1->esimProfiles instead.
     */
    protected function getEsimProfiles(): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\EsimProfileList {
     ...
     */
    protected function contextEsimProfiles(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\EsimProfileContext {
     ...
     */
    protected function getFleets(): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\FleetList {
     ...
     */
    protected function contextFleets(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\FleetContext {
     ...
     */
    protected function getIpCommands(): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\IpCommandList {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextIpCommands(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\IpCommandContext {
     ...
     */
    protected function getNetworks(): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\NetworkList {
     ...
     */
    protected function contextNetworks(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\NetworkContext {
     ...
     */
    protected function getNetworkAccessProfiles(): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\NetworkAccessProfileList {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextNetworkAccessProfiles(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\NetworkAccessProfileContext {
     ...
     */
    protected function getSettingsUpdates(): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\SettingsUpdateList {
     ...
     */
    protected function getSims(): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\SimList {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextSims(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\SimContext {
     ...
     */
    protected function getSmsCommands(): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\SmsCommandList {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextSmsCommands(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\SmsCommandContext {
     ...
     */
    protected function getUsageRecords(): \MagicLogin\Dependencies\Twilio\Rest\Supersim\V1\UsageRecordList {
