 ...
 *
 * MagicLogin\Dependencies\Twilio - Monitor
...
namespace MagicLogin\Dependencies\Twilio\Rest\Monitor;
...
use MagicLogin\Dependencies\Twilio\Rest\Monitor\V1\AlertList;
use MagicLogin\Dependencies\Twilio\Rest\Monitor\V1\EventList;
use MagicLogin\Dependencies\Twilio\Version;

/**
 * @property AlertList $alerts
 * @property EventList $events
 * @method \MagicLogin\Dependencies\Twilio\Rest\Monitor\V1\AlertContext alerts(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Monitor\V1\EventContext events(string $sid)
 */
