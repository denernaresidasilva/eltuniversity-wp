...
use MagicLogin\Dependencies\Twilio\Rest\Pricing\V1\Messaging\CountryList;


/**
 * @property CountryList $countries
 * @method \MagicLogin\Dependencies\Twilio\Rest\Pricing\V1\Messaging\CountryContext countries(string $isoCountry)
 */
