...
namespace MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Conference;
...
abstract class ParticipantOptions
{
     ...
     * @param string $jitterBufferSize Jitter buffer size for the connecting participant. MagicLogin\Dependencies\Twilio will use this setting to apply Jitter Buffer before participant's audio is mixed into the conference. Can be: `off`, `small`, `medium`, and `large`. Default to `large`.
...
class CreateParticipantOptions extends Options
    ...
    /**
     * Jitter buffer size for the connecting participant. MagicLogin\Dependencies\Twilio will use this setting to apply Jitter Buffer before participant's audio is mixed into the conference. Can be: `off`, `small`, `medium`, and `large`. Default to `large`.
     *
     * @param string $jitterBufferSize Jitter buffer size for the connecting participant. MagicLogin\Dependencies\Twilio will use this setting to apply Jitter Buffer before participant's audio is mixed into the conference. Can be: `off`, `small`, `medium`, and `large`. Default to `large`.
     * @return $this Fluent Builder
     */
