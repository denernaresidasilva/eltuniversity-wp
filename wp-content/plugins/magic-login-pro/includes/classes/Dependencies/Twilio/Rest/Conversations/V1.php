...
namespace MagicLogin\Dependencies\Twilio\Rest\Conversations;
...
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\AddressConfigurationList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\ConfigurationList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\ConversationList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\ConversationWithParticipantsList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\CredentialList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\ParticipantConversationList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\RoleList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\ServiceList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\UserList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\AddressConfigurationContext addressConfigurations(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\ConversationContext conversations(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\CredentialContext credentials(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\RoleContext roles(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\ServiceContext services(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\UserContext users(string $sid)
 */
