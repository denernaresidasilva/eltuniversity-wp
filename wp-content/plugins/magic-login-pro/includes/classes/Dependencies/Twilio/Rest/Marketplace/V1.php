...
namespace MagicLogin\Dependencies\Twilio\Rest\Marketplace;
...
use MagicLogin\Dependencies\Twilio\Rest\Marketplace\V1\AvailableAddOnList;
use MagicLogin\Dependencies\Twilio\Rest\Marketplace\V1\InstalledAddOnList;
use MagicLogin\Dependencies\Twilio\Rest\Marketplace\V1\ModuleDataList;
use MagicLogin\Dependencies\Twilio\Rest\Marketplace\V1\ModuleDataManagementList;
use MagicLogin\Dependencies\Twilio\Rest\Marketplace\V1\ReferralConversionList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Marketplace\V1\AvailableAddOnContext availableAddOns(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Marketplace\V1\InstalledAddOnContext installedAddOns(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Marketplace\V1\ModuleDataManagementContext moduleDataManagement(string $sid)
 */
