...
class Preview extends PreviewBase {
     ...
     */
    protected function getFleets(): \MagicLogin\Dependencies\Twilio\Rest\Preview\DeployedDevices\FleetList {
     ...
     */
    protected function contextFleets(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Preview\DeployedDevices\FleetContext {
     ...
     */
    protected function getAuthorizationDocuments(): \MagicLogin\Dependencies\Twilio\Rest\Preview\HostedNumbers\AuthorizationDocumentList {
     ...
     */
    protected function contextAuthorizationDocuments(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Preview\HostedNumbers\AuthorizationDocumentContext {
     ...
     */
    protected function getHostedNumberOrders(): \MagicLogin\Dependencies\Twilio\Rest\Preview\HostedNumbers\HostedNumberOrderList {
     ...
     */
    protected function contextHostedNumberOrders(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Preview\HostedNumbers\HostedNumberOrderContext {
     ...
     */
    protected function getAvailableAddOns(): \MagicLogin\Dependencies\Twilio\Rest\Preview\Marketplace\AvailableAddOnList {
     ...
     */
    protected function contextAvailableAddOns(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Preview\Marketplace\AvailableAddOnContext {
     ...
     */
    protected function getInstalledAddOns(): \MagicLogin\Dependencies\Twilio\Rest\Preview\Marketplace\InstalledAddOnList {
     ...
     */
    protected function contextInstalledAddOns(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Preview\Marketplace\InstalledAddOnContext {
     ...
     */
    protected function getServices(): \MagicLogin\Dependencies\Twilio\Rest\Preview\Sync\ServiceList {
     ...
     */
    protected function contextServices(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Preview\Sync\ServiceContext {
     ...
     */
    protected function getAssistants(): \MagicLogin\Dependencies\Twilio\Rest\Preview\Understand\AssistantList {
     ...
     *                    resource.
     */
    protected function contextAssistants(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Preview\Understand\AssistantContext {
     ...
     */
    protected function getCommands(): \MagicLogin\Dependencies\Twilio\Rest\Preview\Wireless\CommandList {
     ...
     * @param string $sid The sid
     */
    protected function contextCommands(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Preview\Wireless\CommandContext {
     ...
     */
    protected function getRatePlans(): \MagicLogin\Dependencies\Twilio\Rest\Preview\Wireless\RatePlanList {
     ...
     * @param string $sid The sid
     */
    protected function contextRatePlans(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Preview\Wireless\RatePlanContext {
     ...
     */
    protected function getSims(): \MagicLogin\Dependencies\Twilio\Rest\Preview\Wireless\SimList {
     ...
     * @param string $sid The sid
     */
    protected function contextSims(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Preview\Wireless\SimContext {
