 ...
 *
 * MagicLogin\Dependencies\Twilio - Trunking
...
namespace MagicLogin\Dependencies\Twilio\Rest\Trunking\V1;
...
abstract class TrunkOptions
{
     ...
     * @param string $domainName The unique address you reserve on MagicLogin\Dependencies\Twilio to which you route your SIP traffic. Domain names can contain letters, digits, and `-` and must end with `pstn.twilio.com`. See [Termination Settings](https://www.twilio.com/docs/sip-trunking#termination) for more information.
...
class CreateTrunkOptions extends Options
    ...
    /**
     * The unique address you reserve on MagicLogin\Dependencies\Twilio to which you route your SIP traffic. Domain names can contain letters, digits, and `-` and must end with `pstn.twilio.com`. See [Termination Settings](https://www.twilio.com/docs/sip-trunking#termination) for more information.
     *
     * @param string $domainName The unique address you reserve on MagicLogin\Dependencies\Twilio to which you route your SIP traffic. Domain names can contain letters, digits, and `-` and must end with `pstn.twilio.com`. See [Termination Settings](https://www.twilio.com/docs/sip-trunking#termination) for more information.
     * @return $this Fluent Builder
     */
