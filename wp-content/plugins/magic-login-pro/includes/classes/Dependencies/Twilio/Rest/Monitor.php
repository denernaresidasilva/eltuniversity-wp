...
use MagicLogin\Dependencies\Twilio\Rest\Monitor\V1;

class Monitor extends MonitorBase {
    /**
     * @deprecated Use v1->alerts instead.
     */
    protected function getAlerts(): \MagicLogin\Dependencies\Twilio\Rest\Monitor\V1\AlertList {
     ...
     */
    protected function contextAlerts(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Monitor\V1\AlertContext {
     ...
     */
    protected function getEvents(): \MagicLogin\Dependencies\Twilio\Rest\Monitor\V1\EventList {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextEvents(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Monitor\V1\EventContext {
