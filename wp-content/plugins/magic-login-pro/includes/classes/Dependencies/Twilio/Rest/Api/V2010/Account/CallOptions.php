...
abstract class CallOptions
{
     ...
     * @param string $twiml TwiML instructions for the call MagicLogin\Dependencies\Twilio will use without fetching Twiml from url parameter. If both `twiml` and `url` are provided then `twiml` parameter will be ignored. Max 4000 characters.
     ...
     * @param string $twiml TwiML instructions for the call MagicLogin\Dependencies\Twilio will use without fetching Twiml from url. Twiml and url parameters are mutually exclusive
     * @param int $timeLimit The maximum duration of the call in seconds. Constraints depend on account and configuration.
...
class CreateCallOptions extends Options
    ...
    /**
     * TwiML instructions for the call MagicLogin\Dependencies\Twilio will use without fetching Twiml from url parameter. If both `twiml` and `url` are provided then `twiml` parameter will be ignored. Max 4000 characters.
     *
     * @param string $twiml TwiML instructions for the call MagicLogin\Dependencies\Twilio will use without fetching Twiml from url parameter. If both `twiml` and `url` are provided then `twiml` parameter will be ignored. Max 4000 characters.
     * @return $this Fluent Builder
     */
...
class UpdateCallOptions extends Options
    ...
    /**
     * TwiML instructions for the call MagicLogin\Dependencies\Twilio will use without fetching Twiml from url. Twiml and url parameters are mutually exclusive
     *
     * @param string $twiml TwiML instructions for the call MagicLogin\Dependencies\Twilio will use without fetching Twiml from url. Twiml and url parameters are mutually exclusive
     * @return $this Fluent Builder
     */
