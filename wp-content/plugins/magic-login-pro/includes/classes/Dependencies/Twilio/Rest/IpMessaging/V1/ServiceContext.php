...
use MagicLogin\Dependencies\Twilio\Rest\IpMessaging\V1\Service\ChannelList;
use MagicLogin\Dependencies\Twilio\Rest\IpMessaging\V1\Service\RoleList;
use MagicLogin\Dependencies\Twilio\Rest\IpMessaging\V1\Service\UserList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\IpMessaging\V1\Service\ChannelContext channels(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\IpMessaging\V1\Service\RoleContext roles(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\IpMessaging\V1\Service\UserContext users(string $sid)
 */
