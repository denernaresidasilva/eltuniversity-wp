...
namespace MagicLogin\Dependencies\Twilio\Rest\Messaging;
...
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\BrandRegistrationList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\DeactivationsList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\DomainCertsList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\DomainConfigList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\DomainConfigMessagingServiceList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\ExternalCampaignList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\LinkshorteningMessagingServiceList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\LinkshorteningMessagingServiceDomainAssociationList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\RequestManagedCertList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\ServiceList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\TollfreeVerificationList;
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\UsecaseList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\BrandRegistrationContext brandRegistrations(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\LinkshorteningMessagingServiceContext linkshorteningMessagingService(string $domainSid, string $messagingServiceSid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\ServiceContext services(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\TollfreeVerificationContext tollfreeVerifications(string $sid)
 */
