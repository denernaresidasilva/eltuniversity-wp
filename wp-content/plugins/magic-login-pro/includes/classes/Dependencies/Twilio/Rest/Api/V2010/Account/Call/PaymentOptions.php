...
abstract class PaymentOptions
{
     ...
     * @param string $paymentConnector This is the unique name corresponding to the Pay Connector installed in the MagicLogin\Dependencies\Twilio Add-ons. Learn more about [<Pay> Connectors](https://www.twilio.com/console/voice/pay-connectors). The default value is `Default`.
...
class CreatePaymentOptions extends Options
    ...
    /**
     * This is the unique name corresponding to the Pay Connector installed in the MagicLogin\Dependencies\Twilio Add-ons. Learn more about [<Pay> Connectors](https://www.twilio.com/console/voice/pay-connectors). The default value is `Default`.
     *
     * @param string $paymentConnector This is the unique name corresponding to the Pay Connector installed in the MagicLogin\Dependencies\Twilio Add-ons. Learn more about [<Pay> Connectors](https://www.twilio.com/console/voice/pay-connectors). The default value is `Default`.
     * @return $this Fluent Builder
     */
