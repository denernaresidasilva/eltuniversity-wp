...
use MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Message\FeedbackList;
use MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Message\MediaList;


/**
 * @property FeedbackList $feedback
 * @property MediaList $media
 * @method \MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\Message\MediaContext media(string $sid)
 */
