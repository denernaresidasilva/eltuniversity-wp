...
use MagicLogin\Dependencies\Twilio\Rest\Verify\V2;

class Verify extends VerifyBase {
    /**
     * @deprecated Use v2->forms instead.
     */
    protected function getForms(): \MagicLogin\Dependencies\Twilio\Rest\Verify\V2\FormList {
     ...
     */
    protected function contextForms(string $formType): \MagicLogin\Dependencies\Twilio\Rest\Verify\V2\FormContext {
     ...
     */
    protected function getSafelist(): \MagicLogin\Dependencies\Twilio\Rest\Verify\V2\SafelistList {
     ...
     */
    protected function contextSafelist(string $phoneNumber): \MagicLogin\Dependencies\Twilio\Rest\Verify\V2\SafelistContext {
     ...
     */
    protected function getServices(): \MagicLogin\Dependencies\Twilio\Rest\Verify\V2\ServiceList {
     ...
     */
    protected function contextServices(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Verify\V2\ServiceContext {
     ...
     */
    protected function getVerificationAttempts(): \MagicLogin\Dependencies\Twilio\Rest\Verify\V2\VerificationAttemptList {
     ...
     */
    protected function contextVerificationAttempts(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Verify\V2\VerificationAttemptContext {
     ...
     */
    protected function getVerificationAttemptsSummary(): \MagicLogin\Dependencies\Twilio\Rest\Verify\V2\VerificationAttemptsSummaryList {
     ...
     * @deprecated Use v2->verificationAttemptsSummary() instead.
     */
    protected function contextVerificationAttemptsSummary(): \MagicLogin\Dependencies\Twilio\Rest\Verify\V2\VerificationAttemptsSummaryContext {
        echo "verificationAttemptsSummary() is deprecated. Use v2->verificationAttemptsSummary() instead.";
        return $this->v2->verificationAttemptsSummary();
    }
     ...
     */
    protected function getTemplates(): \MagicLogin\Dependencies\Twilio\Rest\Verify\V2\TemplateList {
