...
namespace MagicLogin\Dependencies\Twilio\Rest\FlexApi;
...
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\AssessmentsList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\ChannelList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\ConfigurationList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\FlexFlowList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\InsightsAssessmentsCommentList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\InsightsConversationsList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\InsightsQuestionnairesList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\InsightsQuestionnairesCategoryList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\InsightsQuestionnairesQuestionList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\InsightsSegmentsList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\InsightsSessionList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\InsightsSettingsAnswerSetsList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\InsightsSettingsCommentList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\InsightsUserRolesList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\InteractionList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\PluginList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\PluginArchiveList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\PluginConfigurationList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\PluginConfigurationArchiveList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\PluginReleaseList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\PluginVersionArchiveList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\ProvisioningStatusList;
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\WebChannelList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\ChannelContext channel(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\FlexFlowContext flexFlow(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\AssessmentsContext assessments(string $assessmentSid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\InsightsQuestionnairesContext insightsQuestionnaires(string $questionnaireSid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\InsightsQuestionnairesCategoryContext insightsQuestionnairesCategory(string $categorySid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\InsightsQuestionnairesQuestionContext insightsQuestionnairesQuestion(string $questionSid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\InteractionContext interaction(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\PluginContext plugins(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\PluginConfigurationContext pluginConfigurations(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\PluginReleaseContext pluginReleases(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\WebChannelContext webChannel(string $sid)
 */
