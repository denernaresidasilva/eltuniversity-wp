...
namespace MagicLogin\Dependencies\Twilio\Rest\Serverless\V1\Service;
...
use MagicLogin\Dependencies\Twilio\Rest\Serverless\V1\Service\Environment\LogList;
use MagicLogin\Dependencies\Twilio\Rest\Serverless\V1\Service\Environment\DeploymentList;
use MagicLogin\Dependencies\Twilio\Rest\Serverless\V1\Service\Environment\VariableList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Serverless\V1\Service\Environment\LogContext logs(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Serverless\V1\Service\Environment\VariableContext variables(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Serverless\V1\Service\Environment\DeploymentContext deployments(string $sid)
 */
