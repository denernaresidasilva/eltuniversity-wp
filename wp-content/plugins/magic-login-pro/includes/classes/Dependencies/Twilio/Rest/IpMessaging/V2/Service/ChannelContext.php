...
namespace MagicLogin\Dependencies\Twilio\Rest\IpMessaging\V2\Service;
...
use MagicLogin\Dependencies\Twilio\Rest\IpMessaging\V2\Service\Channel\MemberList;
use MagicLogin\Dependencies\Twilio\Rest\IpMessaging\V2\Service\Channel\InviteList;
use MagicLogin\Dependencies\Twilio\Rest\IpMessaging\V2\Service\Channel\WebhookList;
use MagicLogin\Dependencies\Twilio\Rest\IpMessaging\V2\Service\Channel\MessageList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\IpMessaging\V2\Service\Channel\WebhookContext webhooks(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\IpMessaging\V2\Service\Channel\MemberContext members(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\IpMessaging\V2\Service\Channel\MessageContext messages(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\IpMessaging\V2\Service\Channel\InviteContext invites(string $sid)
 */
