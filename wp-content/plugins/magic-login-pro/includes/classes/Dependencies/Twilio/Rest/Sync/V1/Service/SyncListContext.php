...
namespace MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service;
...
use MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\SyncList\SyncListPermissionList;
use MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\SyncList\SyncListItemList;


/**
 * @property SyncListPermissionList $syncListPermissions
 * @property SyncListItemList $syncListItems
 * @method \MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\SyncList\SyncListPermissionContext syncListPermissions(string $identity)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\SyncList\SyncListItemContext syncListItems(string $index)
 */
