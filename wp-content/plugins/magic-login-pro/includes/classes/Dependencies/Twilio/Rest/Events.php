...
use MagicLogin\Dependencies\Twilio\Rest\Events\V1;
...
class Events extends EventsBase {
     ...
     */
    protected function getEventTypes(): \MagicLogin\Dependencies\Twilio\Rest\Events\V1\EventTypeList {
     ...
     */
    protected function contextEventTypes(string $type): \MagicLogin\Dependencies\Twilio\Rest\Events\V1\EventTypeContext {
     ...
     */
    protected function getSchemas(): \MagicLogin\Dependencies\Twilio\Rest\Events\V1\SchemaList {
     ...
     */
    protected function contextSchemas(string $id): \MagicLogin\Dependencies\Twilio\Rest\Events\V1\SchemaContext {
     ...
     */
    protected function getSinks(): \MagicLogin\Dependencies\Twilio\Rest\Events\V1\SinkList {
     ...
     */
    protected function contextSinks(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Events\V1\SinkContext {
     ...
     */
    protected function getSubscriptions(): \MagicLogin\Dependencies\Twilio\Rest\Events\V1\SubscriptionList {
     ...
     */
    protected function contextSubscriptions(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Events\V1\SubscriptionContext {
