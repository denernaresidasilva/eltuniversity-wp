...
namespace MagicLogin\Dependencies\Twilio\Rest\Microvisor\V1;
...
use MagicLogin\Dependencies\Twilio\Rest\Microvisor\V1\Device\DeviceConfigList;
use MagicLogin\Dependencies\Twilio\Rest\Microvisor\V1\Device\DeviceSecretList;


/**
 * @property DeviceConfigList $deviceConfigs
 * @property DeviceSecretList $deviceSecrets
 * @method \MagicLogin\Dependencies\Twilio\Rest\Microvisor\V1\Device\DeviceSecretContext deviceSecrets(string $key)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Microvisor\V1\Device\DeviceConfigContext deviceConfigs(string $key)
 */
