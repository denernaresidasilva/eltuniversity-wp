...
use MagicLogin\Dependencies\Twilio\Rest\Preview\Sync\Service\SyncMap\SyncMapItemList;
use MagicLogin\Dependencies\Twilio\Rest\Preview\Sync\Service\SyncMap\SyncMapPermissionList;


/**
 * @property SyncMapItemList $syncMapItems
 * @property SyncMapPermissionList $syncMapPermissions
 * @method \MagicLogin\Dependencies\Twilio\Rest\Preview\Sync\Service\SyncMap\SyncMapItemContext syncMapItems(string $key)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Preview\Sync\Service\SyncMap\SyncMapPermissionContext syncMapPermissions(string $identity)
 */
