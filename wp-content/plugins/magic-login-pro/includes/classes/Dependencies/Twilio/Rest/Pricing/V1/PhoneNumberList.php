...
use MagicLogin\Dependencies\Twilio\Rest\Pricing\V1\PhoneNumber\CountryList;


/**
 * @property CountryList $countries
 * @method \MagicLogin\Dependencies\Twilio\Rest\Pricing\V1\PhoneNumber\CountryContext countries(string $isoCountry)
 */
