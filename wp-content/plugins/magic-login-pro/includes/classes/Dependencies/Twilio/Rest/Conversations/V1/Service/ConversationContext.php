...
namespace MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service;
...
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\Conversation\MessageList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\Conversation\WebhookList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\Conversation\ParticipantList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\Conversation\ParticipantContext participants(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\Conversation\WebhookContext webhooks(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\Conversation\MessageContext messages(string $sid)
 */
