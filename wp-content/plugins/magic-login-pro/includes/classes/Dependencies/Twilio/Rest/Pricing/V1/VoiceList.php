...
namespace MagicLogin\Dependencies\Twilio\Rest\Pricing\V1;
...
use MagicLogin\Dependencies\Twilio\Rest\Pricing\V1\Voice\CountryList;
use MagicLogin\Dependencies\Twilio\Rest\Pricing\V1\Voice\NumberList;


/**
 * @property CountryList $countries
 * @property NumberList $numbers
 * @method \MagicLogin\Dependencies\Twilio\Rest\Pricing\V1\Voice\CountryContext countries(string $isoCountry)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Pricing\V1\Voice\NumberContext numbers(string $number)
 */
