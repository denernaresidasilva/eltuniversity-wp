...
namespace MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountry;
...
abstract class TollFreeOptions
{
     ...
     * @param bool $beta Whether to read phone numbers that are new to the MagicLogin\Dependencies\Twilio platform. Can be: `true` or `false` and the default is `true`.
...
class ReadTollFreeOptions extends Options
    ...
    /**
     * Whether to read phone numbers that are new to the MagicLogin\Dependencies\Twilio platform. Can be: `true` or `false` and the default is `true`.
     *
     * @param bool $beta Whether to read phone numbers that are new to the MagicLogin\Dependencies\Twilio platform. Can be: `true` or `false` and the default is `true`.
     * @return $this Fluent Builder
     */
