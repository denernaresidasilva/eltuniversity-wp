...
namespace MagicLogin\Dependencies\Twilio\Rest\Studio\V1;
...
use MagicLogin\Dependencies\Twilio\Rest\Studio\V1\Flow\EngagementList;
use MagicLogin\Dependencies\Twilio\Rest\Studio\V1\Flow\ExecutionList;


/**
 * @property EngagementList $engagements
 * @property ExecutionList $executions
 * @method \MagicLogin\Dependencies\Twilio\Rest\Studio\V1\Flow\ExecutionContext executions(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Studio\V1\Flow\EngagementContext engagements(string $sid)
 */
