...
class DomainCertsInstance extends InstanceResource
{
     ...
     *
     * @param string $tlsCert Contains the full TLS certificate and private for this domain in PEM format: https://en.wikipedia.org/wiki/Privacy-Enhanced_Mail. MagicLogin\Dependencies\Twilio uses this information to process HTTPS traffic sent to your domain.
