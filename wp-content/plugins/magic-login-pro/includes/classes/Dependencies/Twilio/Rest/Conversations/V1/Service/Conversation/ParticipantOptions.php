...
namespace MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\Conversation;
...
abstract class ParticipantOptions
{
     ...
     * @param string $messagingBindingProjectedAddress The address of the MagicLogin\Dependencies\Twilio phone number that is used in Group MMS.
...
class CreateParticipantOptions extends Options
    ...
    /**
     * The address of the MagicLogin\Dependencies\Twilio phone number that is used in Group MMS.
     *
     * @param string $messagingBindingProjectedAddress The address of the MagicLogin\Dependencies\Twilio phone number that is used in Group MMS.
     * @return $this Fluent Builder
     */
