...
abstract class ByocTrunkOptions
{
     ...
     * @param string $connectionPolicySid The SID of the Connection Policy that MagicLogin\Dependencies\Twilio will use when routing traffic to your communications infrastructure.
...
class CreateByocTrunkOptions extends Options
    ...
    /**
     * The SID of the Connection Policy that MagicLogin\Dependencies\Twilio will use when routing traffic to your communications infrastructure.
     *
     * @param string $connectionPolicySid The SID of the Connection Policy that MagicLogin\Dependencies\Twilio will use when routing traffic to your communications infrastructure.
     * @return $this Fluent Builder
     */
