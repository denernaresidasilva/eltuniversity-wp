...
namespace MagicLogin\Dependencies\Twilio\Rest\Numbers;
...
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V1\BulkEligibilityList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V1\EligibilityList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V1\PortingPortInList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V1\PortingPortInPhoneNumberList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V1\PortingPortabilityList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V1\PortingWebhookConfigurationList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V1\PortingWebhookConfigurationDeleteList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V1\SigningRequestConfigurationList;
use MagicLogin\Dependencies\Twilio\Rest\Numbers\V1\WebhookList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Numbers\V1\BulkEligibilityContext bulkEligibilities(string $requestId)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Numbers\V1\PortingPortInContext portingPortIns(string $portInRequestSid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Numbers\V1\PortingPortInPhoneNumberContext portingPortInPhoneNumber(string $portInRequestSid, string $phoneNumberSid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Numbers\V1\PortingPortabilityContext portingPortabilities(string $phoneNumber)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Numbers\V1\PortingWebhookConfigurationDeleteContext portingWebhookConfigurationsDelete(string $webhookType)
 */
