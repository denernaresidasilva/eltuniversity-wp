...
namespace MagicLogin\Dependencies\Twilio\Rest\Conversations\V1;
...
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\ParticipantConversationList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\UserList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\BindingList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\ConversationWithParticipantsList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\ConversationList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\RoleList;
use MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\ConfigurationList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\ConfigurationContext configuration()
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\UserContext users(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\RoleContext roles(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\BindingContext bindings(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Service\ConversationContext conversations(string $sid)
 */
