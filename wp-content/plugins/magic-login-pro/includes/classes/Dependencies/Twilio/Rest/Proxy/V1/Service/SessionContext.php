...
use MagicLogin\Dependencies\Twilio\Rest\Proxy\V1\Service\Session\ParticipantList;
use MagicLogin\Dependencies\Twilio\Rest\Proxy\V1\Service\Session\InteractionList;


/**
 * @property ParticipantList $participants
 * @property InteractionList $interactions
 * @method \MagicLogin\Dependencies\Twilio\Rest\Proxy\V1\Service\Session\InteractionContext interactions(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Proxy\V1\Service\Session\ParticipantContext participants(string $sid)
 */
