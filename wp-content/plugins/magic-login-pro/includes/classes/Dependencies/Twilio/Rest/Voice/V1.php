 ...
 *
 * MagicLogin\Dependencies\Twilio - Voice
...
namespace MagicLogin\Dependencies\Twilio\Rest\Voice;
...
use MagicLogin\Dependencies\Twilio\Rest\Voice\V1\ArchivedCallList;
use MagicLogin\Dependencies\Twilio\Rest\Voice\V1\ByocTrunkList;
use MagicLogin\Dependencies\Twilio\Rest\Voice\V1\ConnectionPolicyList;
use MagicLogin\Dependencies\Twilio\Rest\Voice\V1\DialingPermissionsList;
use MagicLogin\Dependencies\Twilio\Rest\Voice\V1\IpRecordList;
use MagicLogin\Dependencies\Twilio\Rest\Voice\V1\SourceIpMappingList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Voice\V1\ArchivedCallContext archivedCalls(string $date, string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Voice\V1\ByocTrunkContext byocTrunks(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Voice\V1\ConnectionPolicyContext connectionPolicies(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Voice\V1\IpRecordContext ipRecords(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Voice\V1\SourceIpMappingContext sourceIpMappings(string $sid)
 */
