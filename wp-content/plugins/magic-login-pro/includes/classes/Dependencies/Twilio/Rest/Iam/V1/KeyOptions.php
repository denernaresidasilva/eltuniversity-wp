 ...
 *
 * MagicLogin\Dependencies\Twilio - Iam
...
namespace MagicLogin\Dependencies\Twilio\Rest\Iam\V1;
...
abstract class KeyOptions
{
     ...
     * @param array $policy The \\\\`Policy\\\\` object is a collection that specifies the allowed MagicLogin\Dependencies\Twilio permissions for the restricted key. For more information on the permissions available with restricted API keys, refer to the [MagicLogin\Dependencies\Twilio documentation](https://www.twilio.com/docs/iam/api-keys/restricted-api-keys#permissions-available-with-restricted-api-keys).
...
class CreateKeyOptions extends Options
    ...
    /**
     * The \\\\`Policy\\\\` object is a collection that specifies the allowed MagicLogin\Dependencies\Twilio permissions for the restricted key. For more information on the permissions available with restricted API keys, refer to the [MagicLogin\Dependencies\Twilio documentation](https://www.twilio.com/docs/iam/api-keys/restricted-api-keys#permissions-available-with-restricted-api-keys).
     *
     * @param array $policy The \\\\`Policy\\\\` object is a collection that specifies the allowed MagicLogin\Dependencies\Twilio permissions for the restricted key. For more information on the permissions available with restricted API keys, refer to the [MagicLogin\Dependencies\Twilio documentation](https://www.twilio.com/docs/iam/api-keys/restricted-api-keys#permissions-available-with-restricted-api-keys).
     * @return $this Fluent Builder
     */
