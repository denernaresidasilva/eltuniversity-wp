...
namespace MagicLogin\Dependencies\Twilio\Rest\Microvisor;
...
use MagicLogin\Dependencies\Twilio\Rest\Microvisor\V1\AccountConfigList;
use MagicLogin\Dependencies\Twilio\Rest\Microvisor\V1\AccountSecretList;
use MagicLogin\Dependencies\Twilio\Rest\Microvisor\V1\AppList;
use MagicLogin\Dependencies\Twilio\Rest\Microvisor\V1\DeviceList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Microvisor\V1\AccountConfigContext accountConfigs(string $key)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Microvisor\V1\AccountSecretContext accountSecrets(string $key)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Microvisor\V1\AppContext apps(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Microvisor\V1\DeviceContext devices(string $sid)
 */
