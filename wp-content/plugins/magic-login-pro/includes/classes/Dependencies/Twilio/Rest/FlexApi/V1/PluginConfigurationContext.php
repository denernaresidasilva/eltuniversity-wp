...
use MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\PluginConfiguration\ConfiguredPluginList;


/**
 * @property ConfiguredPluginList $plugins
 * @method \MagicLogin\Dependencies\Twilio\Rest\FlexApi\V1\PluginConfiguration\ConfiguredPluginContext plugins(string $pluginSid)
 */
