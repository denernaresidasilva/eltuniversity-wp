...
namespace MagicLogin\Dependencies\Twilio\Rest\Voice\V1\ConnectionPolicy;
...
abstract class ConnectionPolicyTargetOptions
{
    ...
    /**
     * @param string $friendlyName A descriptive string that you create to describe the resource. It is not unique and can be up to 255 characters long.
     * @param string $target The SIP address you want MagicLogin\Dependencies\Twilio to route your calls to. This must be a `sip:` schema. `sips` is NOT supported.
...
class UpdateConnectionPolicyTargetOptions extends Options
    ...
    /**
     * The SIP address you want MagicLogin\Dependencies\Twilio to route your calls to. This must be a `sip:` schema. `sips` is NOT supported.
     *
     * @param string $target The SIP address you want MagicLogin\Dependencies\Twilio to route your calls to. This must be a `sip:` schema. `sips` is NOT supported.
     * @return $this Fluent Builder
     */
