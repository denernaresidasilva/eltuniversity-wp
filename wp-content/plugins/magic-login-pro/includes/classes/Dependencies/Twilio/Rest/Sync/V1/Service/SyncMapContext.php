...
use MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\SyncMap\SyncMapItemList;
use MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\SyncMap\SyncMapPermissionList;


/**
 * @property SyncMapItemList $syncMapItems
 * @property SyncMapPermissionList $syncMapPermissions
 * @method \MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\SyncMap\SyncMapItemContext syncMapItems(string $key)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\SyncMap\SyncMapPermissionContext syncMapPermissions(string $identity)
 */
