...
use MagicLogin\Dependencies\Twilio\Rest\Insights\V1;
...
class Insights extends InsightsBase {
     ...
     */
    protected function getSettings(): \MagicLogin\Dependencies\Twilio\Rest\Insights\V1\SettingList {
     ...
     * @deprecated Use v1->settings() instead.
     */
    protected function contextSettings(): \MagicLogin\Dependencies\Twilio\Rest\Insights\V1\SettingContext {
        echo "settings() is deprecated. Use v1->settings() instead.";
        return $this->v1->settings();
    }
     ...
     */
    protected function getCalls(): \MagicLogin\Dependencies\Twilio\Rest\Insights\V1\CallList {
     ...
     */
    protected function contextCalls(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Insights\V1\CallContext {
     ...
     */
    protected function getCallSummaries(): \MagicLogin\Dependencies\Twilio\Rest\Insights\V1\CallSummariesList {
     ...
     */
    protected function getConferences(): \MagicLogin\Dependencies\Twilio\Rest\Insights\V1\ConferenceList {
     ...
     */
    protected function contextConferences(string $conferenceSid): \MagicLogin\Dependencies\Twilio\Rest\Insights\V1\ConferenceContext {
     ...
     */
    protected function getRooms(): \MagicLogin\Dependencies\Twilio\Rest\Insights\V1\RoomList {
     ...
     */
    protected function contextRooms(string $roomSid): \MagicLogin\Dependencies\Twilio\Rest\Insights\V1\RoomContext {
