...
use MagicLogin\Dependencies\Twilio\Rest\Chat\V2\Service\User\UserBindingList;
use MagicLogin\Dependencies\Twilio\Rest\Chat\V2\Service\User\UserChannelList;


/**
 * @property UserBindingList $userBindings
 * @property UserChannelList $userChannels
 * @method \MagicLogin\Dependencies\Twilio\Rest\Chat\V2\Service\User\UserChannelContext userChannels(string $channelSid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Chat\V2\Service\User\UserBindingContext userBindings(string $sid)
 */
