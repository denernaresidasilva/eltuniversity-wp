...
use MagicLogin\Dependencies\Twilio\Rest\Messaging\V1;

class Messaging extends MessagingBase {
    /**
     * @deprecated
     */
    protected function getBrandRegistrations(): \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\BrandRegistrationList {
     ...
     */
    protected function contextBrandRegistrations(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\BrandRegistrationContext {
     ...
     * @deprecated
     */
    protected function getDeactivations(): \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\DeactivationsList {
     ...
     */
    protected function contextDeactivations(): \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\DeactivationsContext {
        echo "deactivations() is deprecated. Use v1->deactivations() instead.";
        return $this->v1->deactivations();
    }
     ...
     */
    protected function getDomainCerts(): \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\DomainCertsList {
     ...
     */
    protected function contextDomainCerts(string $domainSid): \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\DomainCertsContext {
     ...
     */
    protected function getDomainConfig(): \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\DomainConfigList {
     ...
     */
    protected function contextDomainConfig(string $domainSid): \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\DomainConfigContext {
     ...
     */
    protected function getExternalCampaign(): \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\ExternalCampaignList {
     ...
     */
    protected function getServices(): \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\ServiceList {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextServices(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\ServiceContext {
     ...
     */
    protected function getTollfreeVerifications(): \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\TollfreeVerificationList {
     ...
     */
    protected function contextTollfreeVerifications(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\TollfreeVerificationContext {
     ...
     */
    protected function getUsecases(): \MagicLogin\Dependencies\Twilio\Rest\Messaging\V1\UsecaseList {
