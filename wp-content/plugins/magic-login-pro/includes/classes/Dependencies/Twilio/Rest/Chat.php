...
use MagicLogin\Dependencies\Twilio\Rest\Chat\V2;
use MagicLogin\Dependencies\Twilio\Rest\Chat\V3;
class Chat extends ChatBase {

    /**
     * @deprecated Use v2->credentials instead.
     */
    protected function getCredentials(): \MagicLogin\Dependencies\Twilio\Rest\Chat\V2\CredentialList {
     ...
     */
    protected function contextCredentials(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Chat\V2\CredentialContext {
     ...
     */
    protected function getServices(): \MagicLogin\Dependencies\Twilio\Rest\Chat\V2\ServiceList {
     ...
     */
    protected function contextServices(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Chat\V2\ServiceContext {
     ...
     */
    protected function getChannels(): \MagicLogin\Dependencies\Twilio\Rest\Chat\V3\ChannelList {
     ...
     */
    protected function contextChannels(string $serviceSid, string $sid): \MagicLogin\Dependencies\Twilio\Rest\Chat\V3\ChannelContext {
