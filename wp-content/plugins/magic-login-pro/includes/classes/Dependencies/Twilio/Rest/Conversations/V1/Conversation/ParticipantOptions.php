 ...
 *
 * MagicLogin\Dependencies\Twilio - Conversations
...
namespace MagicLogin\Dependencies\Twilio\Rest\Conversations\V1\Conversation;
...
abstract class ParticipantOptions
{
     ...
     * @param string $messagingBindingProxyAddress The address of the MagicLogin\Dependencies\Twilio phone number (or WhatsApp number) that the participant is in contact with. This field, together with participant address, is only null when the participant is interacting from an SDK endpoint (see the 'identity' field).
     ...
     * @param string $messagingBindingProjectedAddress The address of the MagicLogin\Dependencies\Twilio phone number that is used in Group MMS. Communication mask for the Conversation participant with Identity.
     ...
     * @param string $attributes An optional string metadata field you can use to store any data you wish. The string value must contain structurally valid JSON if specified.  **Note** that if the attributes are not set \\\"{}\\\" will be returned.
     * @param string $roleSid The SID of a conversation-level [Role](https://www.twilio.com/docs/conversations/api/role-resource) to assign to the participant.
     * @param string $messagingBindingProxyAddress The address of the MagicLogin\Dependencies\Twilio phone number that the participant is in contact with. 'null' value will remove it.
     * @param string $messagingBindingProjectedAddress The address of the MagicLogin\Dependencies\Twilio phone number that is used in Group MMS. 'null' value will remove it.
     * @param string $identity A unique string identifier for the conversation participant as [Conversation User](https://www.twilio.com/docs/conversations/api/user-resource). This parameter is non-null if (and only if) the participant is using the Conversations SDK to communicate. Limited to 256 characters.
...
class CreateParticipantOptions extends Options
    ...
    /**
     * The address of the MagicLogin\Dependencies\Twilio phone number (or WhatsApp number) that the participant is in contact with. This field, together with participant address, is only null when the participant is interacting from an SDK endpoint (see the 'identity' field).
     *
     * @param string $messagingBindingProxyAddress The address of the MagicLogin\Dependencies\Twilio phone number (or WhatsApp number) that the participant is in contact with. This field, together with participant address, is only null when the participant is interacting from an SDK endpoint (see the 'identity' field).
     * @return $this Fluent Builder
     */
    ...
    /**
     * The address of the MagicLogin\Dependencies\Twilio phone number that is used in Group MMS. Communication mask for the Conversation participant with Identity.
     *
     * @param string $messagingBindingProjectedAddress The address of the MagicLogin\Dependencies\Twilio phone number that is used in Group MMS. Communication mask for the Conversation participant with Identity.
     * @return $this Fluent Builder
     */
...
class UpdateParticipantOptions extends Options
    ...
    /**
     * The address of the MagicLogin\Dependencies\Twilio phone number that the participant is in contact with. 'null' value will remove it.
     *
     * @param string $messagingBindingProxyAddress The address of the MagicLogin\Dependencies\Twilio phone number that the participant is in contact with. 'null' value will remove it.
     * @return $this Fluent Builder
     */
    ...
    /**
     * The address of the MagicLogin\Dependencies\Twilio phone number that is used in Group MMS. 'null' value will remove it.
     *
     * @param string $messagingBindingProjectedAddress The address of the MagicLogin\Dependencies\Twilio phone number that is used in Group MMS. 'null' value will remove it.
     * @return $this Fluent Builder
     */
