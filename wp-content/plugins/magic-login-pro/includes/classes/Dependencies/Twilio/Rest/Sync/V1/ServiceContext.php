 ...
 *
 * MagicLogin\Dependencies\Twilio - Sync
...
namespace MagicLogin\Dependencies\Twilio\Rest\Sync\V1;
...
use MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\SyncListList;
use MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\SyncStreamList;
use MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\DocumentList;
use MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\SyncMapList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\SyncStreamContext syncStreams(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\SyncListContext syncLists(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\SyncMapContext syncMaps(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Sync\V1\Service\DocumentContext documents(string $sid)
 */
