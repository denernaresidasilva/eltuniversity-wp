...
abstract class StreamOptions
{
     ...
     * @param string $track
     * @param string $statusCallback Absolute URL to which MagicLogin\Dependencies\Twilio sends status callback HTTP requests.
     * @param string $statusCallbackMethod The HTTP method MagicLogin\Dependencies\Twilio uses when sending `status_callback` requests. Possible values are `GET` and `POST`. Default is `POST`.
...
class CreateStreamOptions extends Options
    ...
    /**
     * Absolute URL to which MagicLogin\Dependencies\Twilio sends status callback HTTP requests.
     *
     * @param string $statusCallback Absolute URL to which MagicLogin\Dependencies\Twilio sends status callback HTTP requests.
     * @return $this Fluent Builder
     */
    ...
    /**
     * The HTTP method MagicLogin\Dependencies\Twilio uses when sending `status_callback` requests. Possible values are `GET` and `POST`. Default is `POST`.
     *
     * @param string $statusCallbackMethod The HTTP method MagicLogin\Dependencies\Twilio uses when sending `status_callback` requests. Possible values are `GET` and `POST`. Default is `POST`.
     * @return $this Fluent Builder
     */
