...
namespace MagicLogin\Dependencies\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber;
...
abstract class MobileOptions
{
    ...
    /**
     * @param bool $beta Whether to include phone numbers new to the MagicLogin\Dependencies\Twilio platform. Can be: `true` or `false` and the default is `true`.
...
class ReadMobileOptions extends Options
    ...
    /**
     * Whether to include phone numbers new to the MagicLogin\Dependencies\Twilio platform. Can be: `true` or `false` and the default is `true`.
     *
     * @param bool $beta Whether to include phone numbers new to the MagicLogin\Dependencies\Twilio platform. Can be: `true` or `false` and the default is `true`.
     * @return $this Fluent Builder
     */
