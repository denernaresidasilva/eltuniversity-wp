...
namespace MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1;
...
use MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\TaskQueueList;
use MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\EventList;
use MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\TaskChannelList;
use MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\ActivityList;
use MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\WorkerList;
use MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\WorkflowList;
use MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\TaskList;
use MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\WorkspaceCumulativeStatisticsList;
use MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\WorkspaceRealTimeStatisticsList;
use MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\WorkspaceStatisticsList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\WorkspaceCumulativeStatisticsContext cumulativeStatistics()
 * @method \MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\TaskQueueContext taskQueues(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\ActivityContext activities(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\WorkspaceRealTimeStatisticsContext realTimeStatistics()
 * @method \MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\TaskContext tasks(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\WorkflowContext workflows(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\EventContext events(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\WorkerContext workers(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\WorkspaceStatisticsContext statistics()
 * @method \MagicLogin\Dependencies\Twilio\Rest\Taskrouter\V1\Workspace\TaskChannelContext taskChannels(string $sid)
 */
