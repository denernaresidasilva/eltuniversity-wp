...
use MagicLogin\Dependencies\Twilio\Rest\Routes\V2;

class Routes extends RoutesBase {
    /**
     * @deprecated Use v2->phoneNumbers instead.
     */
    protected function getPhoneNumbers(): \MagicLogin\Dependencies\Twilio\Rest\Routes\V2\PhoneNumberList {
     ...
     */
    protected function contextPhoneNumbers(string $phoneNumber): \MagicLogin\Dependencies\Twilio\Rest\Routes\V2\PhoneNumberContext {
     ...
     */
    protected function getSipDomains(): \MagicLogin\Dependencies\Twilio\Rest\Routes\V2\SipDomainList {
     ...
     */
    protected function contextSipDomains(string $sipDomain): \MagicLogin\Dependencies\Twilio\Rest\Routes\V2\SipDomainContext {
     ...
     */
    protected function getTrunks(): \MagicLogin\Dependencies\Twilio\Rest\Routes\V2\TrunkList {
     ...
     */
    protected function contextTrunks(string $sipTrunkDomain): \MagicLogin\Dependencies\Twilio\Rest\Routes\V2\TrunkContext {
