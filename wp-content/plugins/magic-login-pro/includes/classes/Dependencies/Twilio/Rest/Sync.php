...
use MagicLogin\Dependencies\Twilio\Rest\Sync\V1;
class Sync extends SyncBase {
    /**
     * @deprecated Use v1->services instead.
     */
    protected function getServices(): \MagicLogin\Dependencies\Twilio\Rest\Sync\V1\ServiceList {
     ...
     */
    protected function contextServices(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Sync\V1\ServiceContext {
