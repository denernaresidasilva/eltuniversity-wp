...
use MagicLogin\Dependencies\Twilio\Rest\Trusthub\V1;

class Trusthub extends TrusthubBase {
    /**
     * @deprecated Use v1->customerProfiles instead.
     */
    protected function getCustomerProfiles(): \MagicLogin\Dependencies\Twilio\Rest\Trusthub\V1\CustomerProfilesList {
     ...
     */
    protected function contextCustomerProfiles(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Trusthub\V1\CustomerProfilesContext {
     ...
     */
    protected function getEndUsers(): \MagicLogin\Dependencies\Twilio\Rest\Trusthub\V1\EndUserList {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextEndUsers(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Trusthub\V1\EndUserContext {
     ...
     */
    protected function getEndUserTypes(): \MagicLogin\Dependencies\Twilio\Rest\Trusthub\V1\EndUserTypeList {
     ...
     *                    resource
     */
    protected function contextEndUserTypes(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Trusthub\V1\EndUserTypeContext {
     ...
     */
    protected function getPolicies(): \MagicLogin\Dependencies\Twilio\Rest\Trusthub\V1\PoliciesList {
     ...
     */
    protected function contextPolicies(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Trusthub\V1\PoliciesContext {
     ...
     */
    protected function getSupportingDocuments(): \MagicLogin\Dependencies\Twilio\Rest\Trusthub\V1\SupportingDocumentList {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextSupportingDocuments(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Trusthub\V1\SupportingDocumentContext {
     ...
     */
    protected function getSupportingDocumentTypes(): \MagicLogin\Dependencies\Twilio\Rest\Trusthub\V1\SupportingDocumentTypeList {
     ...
     *                    Type resource
     */
    protected function contextSupportingDocumentTypes(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Trusthub\V1\SupportingDocumentTypeContext {
     ...
     */
    protected function getTrustProducts(): \MagicLogin\Dependencies\Twilio\Rest\Trusthub\V1\TrustProductsList {
     ...
     * @param string $sid The unique string that identifies the resource.
     */
    protected function contextTrustProducts(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Trusthub\V1\TrustProductsContext {
