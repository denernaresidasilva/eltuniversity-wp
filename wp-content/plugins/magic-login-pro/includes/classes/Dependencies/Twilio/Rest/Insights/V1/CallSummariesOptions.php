...
namespace MagicLogin\Dependencies\Twilio\Rest\Insights\V1;
...
{
    /**
     * @param string $from A calling party. Could be an E.164 number, a SIP URI, or a MagicLogin\Dependencies\Twilio Client registered name.
     * @param string $to A called party. Could be an E.164 number, a SIP URI, or a MagicLogin\Dependencies\Twilio Client registered name.
     ...
     * @param bool $brandedEnabled A boolean flag indicating whether or not the calls were branded using MagicLogin\Dependencies\Twilio Branded Calls. One of 'true' or 'false'
...
class ReadCallSummariesOptions extends Options
    ...
    /**
     * A calling party. Could be an E.164 number, a SIP URI, or a MagicLogin\Dependencies\Twilio Client registered name.
     *
     * @param string $from A calling party. Could be an E.164 number, a SIP URI, or a MagicLogin\Dependencies\Twilio Client registered name.
    ...
    /**
     * A called party. Could be an E.164 number, a SIP URI, or a MagicLogin\Dependencies\Twilio Client registered name.
     *
     * @param string $to A called party. Could be an E.164 number, a SIP URI, or a MagicLogin\Dependencies\Twilio Client registered name.
     * @return $this Fluent Builder
     */
    ...
    /**
     * A boolean flag indicating whether or not the calls were branded using MagicLogin\Dependencies\Twilio Branded Calls. One of 'true' or 'false'
     *
     * @param bool $brandedEnabled A boolean flag indicating whether or not the calls were branded using MagicLogin\Dependencies\Twilio Branded Calls. One of 'true' or 'false'
     * @return $this Fluent Builder
     */
