...
use MagicLogin\Dependencies\Twilio\Rest\Bulkexports\V1\Export\JobList;


/**
 * @property JobList $jobs
 * @method \MagicLogin\Dependencies\Twilio\Rest\Bulkexports\V1\Export\JobContext jobs(string $jobSid)
 */
