...
use MagicLogin\Dependencies\Twilio\Rest\Events\V1\Schema\SchemaVersionList;


/**
 * @property SchemaVersionList $versions
 * @method \MagicLogin\Dependencies\Twilio\Rest\Events\V1\Schema\SchemaVersionContext versions(string $schemaVersion)
 */
