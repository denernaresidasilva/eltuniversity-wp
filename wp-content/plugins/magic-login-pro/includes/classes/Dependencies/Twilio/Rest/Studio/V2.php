...
namespace MagicLogin\Dependencies\Twilio\Rest\Studio;
...
use MagicLogin\Dependencies\Twilio\Rest\Studio\V2\FlowList;
use MagicLogin\Dependencies\Twilio\Rest\Studio\V2\FlowValidateList;
use MagicLogin\Dependencies\Twilio\Version;

/**
 * @property FlowList $flows
 * @property FlowValidateList $flowValidate
 * @method \MagicLogin\Dependencies\Twilio\Rest\Studio\V2\FlowContext flows(string $sid)
 */
