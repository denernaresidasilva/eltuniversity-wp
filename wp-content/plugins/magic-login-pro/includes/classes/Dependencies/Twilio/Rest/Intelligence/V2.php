...
namespace MagicLogin\Dependencies\Twilio\Rest\Intelligence;
...
use MagicLogin\Dependencies\Twilio\Rest\Intelligence\V2\CustomOperatorList;
use MagicLogin\Dependencies\Twilio\Rest\Intelligence\V2\OperatorList;
use MagicLogin\Dependencies\Twilio\Rest\Intelligence\V2\OperatorAttachmentList;
use MagicLogin\Dependencies\Twilio\Rest\Intelligence\V2\OperatorAttachmentsList;
use MagicLogin\Dependencies\Twilio\Rest\Intelligence\V2\OperatorTypeList;
use MagicLogin\Dependencies\Twilio\Rest\Intelligence\V2\PrebuiltOperatorList;
use MagicLogin\Dependencies\Twilio\Rest\Intelligence\V2\ServiceList;
use MagicLogin\Dependencies\Twilio\Rest\Intelligence\V2\TranscriptList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Intelligence\V2\CustomOperatorContext customOperators(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Intelligence\V2\OperatorContext operators(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Intelligence\V2\OperatorAttachmentContext operatorAttachment(string $serviceSid, string $operatorSid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Intelligence\V2\OperatorTypeContext operatorType(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Intelligence\V2\PrebuiltOperatorContext prebuiltOperators(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Intelligence\V2\ServiceContext services(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Intelligence\V2\TranscriptContext transcripts(string $sid)
 */
