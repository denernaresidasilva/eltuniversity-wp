...
use MagicLogin\Dependencies\Twilio\Rest\Pricing\V1;
use MagicLogin\Dependencies\Twilio\Rest\Pricing\V2;

class Pricing extends PricingBase {
    /**
     * @deprecated Use v1->messaging instead.
     */
    protected function getMessaging(): \MagicLogin\Dependencies\Twilio\Rest\Pricing\V1\MessagingList {
     ...
     */
    protected function getPhoneNumbers(): \MagicLogin\Dependencies\Twilio\Rest\Pricing\V1\PhoneNumberList {
     ...
     */
    protected function getVoice(): \MagicLogin\Dependencies\Twilio\Rest\Pricing\V2\VoiceList {
     ...
     */
    protected function getCountries(): \MagicLogin\Dependencies\Twilio\Rest\Pricing\V2\CountryList {
     ...
     *                           fetch
     */
    protected function contextCountries(string $isoCountry): \MagicLogin\Dependencies\Twilio\Rest\Pricing\V2\CountryContext {
     ...
     */
    protected function getNumbers(): \MagicLogin\Dependencies\Twilio\Rest\Pricing\V2\NumberList {
     ...
     *                                  pricing information
     */
    protected function contextNumbers(string $destinationNumber): \MagicLogin\Dependencies\Twilio\Rest\Pricing\V2\NumberContext {
