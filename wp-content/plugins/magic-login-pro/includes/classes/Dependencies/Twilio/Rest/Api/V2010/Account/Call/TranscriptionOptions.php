...
abstract class TranscriptionOptions
{
     ...
     * @param string $transcriptionEngine Definition of the transcription engine to be used, among those supported by MagicLogin\Dependencies\Twilio
...
class CreateTranscriptionOptions extends Options
    ...
    /**
     * Definition of the transcription engine to be used, among those supported by MagicLogin\Dependencies\Twilio
     *
     * @param string $transcriptionEngine Definition of the transcription engine to be used, among those supported by MagicLogin\Dependencies\Twilio
     * @return $this Fluent Builder
     */
