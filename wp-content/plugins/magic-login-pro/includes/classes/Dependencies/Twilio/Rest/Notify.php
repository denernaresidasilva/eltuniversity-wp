...
use MagicLogin\Dependencies\Twilio\Rest\Notify\V1;

class Notify extends NotifyBase {
    /**
     * @deprecated Use v1->credentials instead.
     */
    protected function getCredentials(): \MagicLogin\Dependencies\Twilio\Rest\Notify\V1\CredentialList {
     ...
     */
    protected function contextCredentials(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Notify\V1\CredentialContext {
     ...
     */
    protected function getServices(): \MagicLogin\Dependencies\Twilio\Rest\Notify\V1\ServiceList {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextServices(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Notify\V1\ServiceContext {
