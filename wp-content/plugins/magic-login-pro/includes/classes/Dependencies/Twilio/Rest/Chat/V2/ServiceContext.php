...
use MagicLogin\Dependencies\Twilio\Rest\Chat\V2\Service\ChannelList;
use MagicLogin\Dependencies\Twilio\Rest\Chat\V2\Service\BindingList;
use MagicLogin\Dependencies\Twilio\Rest\Chat\V2\Service\RoleList;
use MagicLogin\Dependencies\Twilio\Rest\Chat\V2\Service\UserList;
 ...
 * @method \MagicLogin\Dependencies\Twilio\Rest\Chat\V2\Service\BindingContext bindings(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Chat\V2\Service\ChannelContext channels(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Chat\V2\Service\RoleContext roles(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Chat\V2\Service\UserContext users(string $sid)
 */
