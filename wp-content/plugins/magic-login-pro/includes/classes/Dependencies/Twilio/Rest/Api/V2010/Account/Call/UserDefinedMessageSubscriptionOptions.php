...
abstract class UserDefinedMessageSubscriptionOptions
{
     ...
     * @param string $method The HTTP method MagicLogin\Dependencies\Twilio will use when requesting the above `Url`. Either `GET` or `POST`. Default is `POST`.
...
class CreateUserDefinedMessageSubscriptionOptions extends Options
    ...
    /**
     * The HTTP method MagicLogin\Dependencies\Twilio will use when requesting the above `Url`. Either `GET` or `POST`. Default is `POST`.
     *
     * @param string $method The HTTP method MagicLogin\Dependencies\Twilio will use when requesting the above `Url`. Either `GET` or `POST`. Default is `POST`.
     * @return $this Fluent Builder
     */
