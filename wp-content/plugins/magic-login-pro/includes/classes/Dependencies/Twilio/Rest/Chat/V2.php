...
use MagicLogin\Dependencies\Twilio\Rest\Chat\V2\CredentialList;
use MagicLogin\Dependencies\Twilio\Rest\Chat\V2\ServiceList;
use MagicLogin\Dependencies\Twilio\Version;

/**
 * @property CredentialList $credentials
 * @property ServiceList $services
 * @method \MagicLogin\Dependencies\Twilio\Rest\Chat\V2\CredentialContext credentials(string $sid)
 * @method \MagicLogin\Dependencies\Twilio\Rest\Chat\V2\ServiceContext services(string $sid)
 */
