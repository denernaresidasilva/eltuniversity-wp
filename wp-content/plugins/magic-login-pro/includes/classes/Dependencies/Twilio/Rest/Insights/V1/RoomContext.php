...
use MagicLogin\Dependencies\Twilio\Rest\Insights\V1\Room\ParticipantList;


/**
 * @property ParticipantList $participants
 * @method \MagicLogin\Dependencies\Twilio\Rest\Insights\V1\Room\ParticipantContext participants(string $participantSid)
 */
