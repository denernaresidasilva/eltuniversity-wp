...
use MagicLogin\Dependencies\Twilio\Rest\Serverless\V1;

class Serverless extends ServerlessBase {
    /**
     * @deprecated Use v1->services instead.
     */
    protected function getServices(): \MagicLogin\Dependencies\Twilio\Rest\Serverless\V1\ServiceList {
     ...
     */
    protected function contextServices(string $sid): \MagicLogin\Dependencies\Twilio\Rest\Serverless\V1\ServiceContext {
