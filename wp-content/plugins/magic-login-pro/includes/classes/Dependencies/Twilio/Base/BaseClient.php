<?php
namespace MagicLogin\Dependencies\Twilio\Base;

use MagicLogin\Dependencies\Twilio\Exceptions\ConfigurationException;
use MagicLogin\Dependencies\Twilio\Exceptions\TwilioException;
use MagicLogin\Dependencies\Twilio\Http\Client as HttpClient;
use MagicLogin\Dependencies\Twilio\Http\CurlClient;
use MagicLogin\Dependencies\Twilio\Rest\Api;
use MagicLogin\Dependencies\Twilio\Security\RequestValidator;
use MagicLogin\Dependencies\Twilio\VersionInfo;

/**
 * @property \MagicLogin\Dependencies\Twilio\Rest\Api\V2010\AccountInstance $account
 * @property Api $api
 */
class BaseClient
{
    ...
    /**
     * Initializes the MagicLogin\Dependencies\Twilio Client
     *
    ...
    /**
     * Makes a request to the MagicLogin\Dependencies\Twilio API using the configured http client
     ...
     * @return \MagicLogin\Dependencies\Twilio\Http\Response Response from the MagicLogin\Dependencies\Twilio API
     */
    public function request(
        ...
        ?string $password = null,
        ?int $timeout = null
    ): \MagicLogin\Dependencies\Twilio\Http\Response{
        ...
        if ($logLevel === 'debug') {
            error_log('-- BEGIN MagicLogin\Dependencies\Twilio API Request --');
            ...
            error_log('-- END MagicLogin\Dependencies\Twilio API Request --');
        }
     ...
     * @return \MagicLogin\Dependencies\Twilio\Domain The requested domain
     ...
     * @return \MagicLogin\Dependencies\Twilio\InstanceContext The requested context
     ...
     */
    public function getAccount(): \MagicLogin\Dependencies\Twilio\Rest\Api\V2010\AccountContext
    {
