...
function register_blocks() {
	...
	wp_set_script_translations(
		'magic-login-block-editor',
		'magic-login',
		plugin_dir_path( MAGIC_LOGIN_PRO_PLUGIN_FILE ) . 'languages'
	);
	...
	wp_register_style(
		...
		MAGIC_LOGIN_PRO_URL . 'dist/css/login-block-style.css',
		$deps,
		MAGIC_LOGIN_PRO_VERSION
	);
...
function render_login_block( $args ) {
	...
	/**
	 * Filter the form action URL for the login block.
	 *
	 * @hook magic_login_login_block_form_action
	 *
