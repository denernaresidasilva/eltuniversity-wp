...
<div role="tabpanel" tabindex="0" id="registration__content" class="sui-tab-content magic-login-main-tab-content" aria-labelledby="registration__tab" hidden="">
	<!-- Registration -->
		...
		<div class="sui-box-settings-col-2">
			...
			<div class="sui-form-field">
				...
				<input
					...
					type="text"
					value="<?php echo esc_attr__( $settings['registration']['email_subject'], 'magic-login' ); // phpcs:ignore ?>"
				/>
			</div>
			...
			<div class="sui-form-field">
				...
				<?php
				wp_editor(
					__( $settings['registration']['email_content'], 'magic-login' ), // phpcs:ignore
			...
			<div class="sui-form-field">
				...
				<div style=" <?php echo( ! $settings['registration']['enable_redirection'] ? 'display:none' : '' ); ?>" tabindex="0" id="enable-registration-redirection-controls" class="sui-toggle-content sui-border-frame">
					<div class="sui-form-field">
						...
						/>
						<span class="sui-description" id="description-registration-redirection-url">
