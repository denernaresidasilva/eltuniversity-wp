...
class ComposerStaticInit6208efee542a702479054e3766f8f6de
{
    ...
    public static $classMap = array (
        ...
        'ZapWA\\AntiSpam' => __DIR__ . '/../..' . '/includes/AntiSpam.php',
        'ZapWA\\Broadcast' => __DIR__ . '/../..' . '/includes/Broadcast.php',
        'ZapWA\\ConnectionManager' => __DIR__ . '/../..' . '/includes/ConnectionManager.php',
        'ZapWA\\Cron' => __DIR__ . '/../..' . '/includes/Cron.php',
        'ZapWA\\EventLogReader' => __DIR__ . '/../..' . '/includes/EventLogReader.php',
        'ZapWA\\EvolutionAPI' => __DIR__ . '/../..' . '/includes/EvolutionAPI.php',
        'ZapWA\\HealthCheck' => __DIR__ . '/../..' . '/includes/HealthCheck.php',
        'ZapWA\\Helpers' => __DIR__ . '/../..' . '/includes/Helpers.php',
        'ZapWA\\Installer' => __DIR__ . '/../..' . '/includes/Installer.php',
        'ZapWA\\Listener' => __DIR__ . '/../..' . '/includes/Listener.php',
        'ZapWA\\Loader' => __DIR__ . '/../..' . '/includes/Loader.php',
        'ZapWA\\Logger' => __DIR__ . '/../..' . '/includes/Logger.php',
        'ZapWA\\Metrics' => __DIR__ . '/../..' . '/includes/Metrics.php',
        'ZapWA\\PostTypes\\Message' => __DIR__ . '/../..' . '/includes/PostTypes/Message.php',
        'ZapWA\\QRCodeGenerator' => __DIR__ . '/../..' . '/includes/QRCodeGenerator.php',
        'ZapWA\\Queue' => __DIR__ . '/../..' . '/includes/Queue.php',
        'ZapWA\\Variables' => __DIR__ . '/../..' . '/includes/Variables.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit6208efee542a702479054e3766f8f6de::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit6208efee542a702479054e3766f8f6de::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit6208efee542a702479054e3766f8f6de::$classMap;
