...
return array(
    ...
    'ZapWA\\AntiSpam' => $baseDir . '/includes/AntiSpam.php',
    'ZapWA\\Broadcast' => $baseDir . '/includes/Broadcast.php',
    'ZapWA\\ConnectionManager' => $baseDir . '/includes/ConnectionManager.php',
    'ZapWA\\Cron' => $baseDir . '/includes/Cron.php',
    'ZapWA\\EventLogReader' => $baseDir . '/includes/EventLogReader.php',
    'ZapWA\\EvolutionAPI' => $baseDir . '/includes/EvolutionAPI.php',
    'ZapWA\\HealthCheck' => $baseDir . '/includes/HealthCheck.php',
    'ZapWA\\Helpers' => $baseDir . '/includes/Helpers.php',
    'ZapWA\\Installer' => $baseDir . '/includes/Installer.php',
    'ZapWA\\Listener' => $baseDir . '/includes/Listener.php',
    'ZapWA\\Loader' => $baseDir . '/includes/Loader.php',
    'ZapWA\\Logger' => $baseDir . '/includes/Logger.php',
    'ZapWA\\Metrics' => $baseDir . '/includes/Metrics.php',
    'ZapWA\\PostTypes\\Message' => $baseDir . '/includes/PostTypes/Message.php',
    'ZapWA\\QRCodeGenerator' => $baseDir . '/includes/QRCodeGenerator.php',
    'ZapWA\\Queue' => $baseDir . '/includes/Queue.php',
    'ZapWA\\Variables' => $baseDir . '/includes/Variables.php',
